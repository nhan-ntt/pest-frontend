...
export function InfiniteSelect({
  ...
  const _disabled = useMemo(
    () => (disabled ? (typeof disabled === 'boolean' ? disabled : disabled(values)) : disabled),
    [disabled, values],
  );
    ...
    return {
      control: (base, props1) => {
        ...
        return {
          ...
          borderColor: !fieldMeta.touched ? '#E4E6EF' : fieldMeta.error ? '#f10d0d' : '#27ae60',
          borderRadius: '0.42rem',
          borderWidth: '1px',
          minHeight: '2.3rem',
          fontFamily: 'SVN-Gilroy, Roboto, Poppins, Helvetica, sans-serif',
          ':hover': { borderColor: '#27ae60' },
          ':focus': { borderColor: '#27ae60' },
          fontSize: '12px',
        };
      },
          ...
          <CustomAsyncPaginate
            ...
            value={
              formatter
                ...
                : keyField && keyField != ''
                ? field.value && field.value[keyField]
                  ? field.value
                  : ''
                : [field.value]
            }
            ...
            onChange={(value: any, action) => {
              if (onChange) {
                ...
                setFieldValue(
                  name,
                  onChange(value, { setFieldTouched, setFieldValue, values }) ?? value,
                );
              }
            ...
            placeholder={
              _disabled
                ...
                : intl.formatMessage(
                    { id: placeholder },
                    { label: _.isString(_label) ? _label : '' },
                  )
            }
            styles={styles}
