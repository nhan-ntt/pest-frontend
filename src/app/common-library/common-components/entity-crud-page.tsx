          ...
          <>
            <Form className="form form-label-right">
              {Object.keys(modifyPanels).map((key, index, keys) => {
                ...
                return (
                  <Card
                    key={`entity-crud-card` + key}
                    className={!isBackHome ? 'pt-4' : 'modify-page'}>
                    <CardHeader
                      ...
                      title={
                        index == 0 ? (
                          <a
                            ...
                            {isBackHome && <ArrowBackIosIcon />}
                            {_header && _.isString(_header)
                              ? intl
                                  .formatMessage(
                                    { id: _header },
                                    {
                              ...
                              case 'submit':
                                return (
                                  <button
                                    ...
                                    type={'submit'}>
                                    {loading === true
                                      ? actions.data[keyss].loading ?? (
                                          <Spinner animation="border" variant="light" size="sm" />
                                        )
                                      : actions.data[keyss].icon}{' '}
                                    {intl.formatMessage({ id: actions.data[keyss].label })}
                                  </button>
                                );
