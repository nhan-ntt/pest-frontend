                ...
                {searchModel ? (
                  Object.keys(searchModel).map(key => {
                    ...
                    switch (searchModel[key].type) {
                      ...
                      case 'search-select': {
                        if (
                          searchModel[key].onSearch === undefined ||
                          searchModel[key].onSearch === null
                        )
                          return;
                      ...
                      case 'radio': {
                        return (
                          <InputRadio
                            // className={defaultClassName}
                            options={
                              searchModel[key].option || [
                                { label: 'USER.OPTION.ACTIVE', value: true },
                                { label: 'USER.OPTION.BANNED', value: false },
                              ]
                            }
                            value={values[key]}
                            name={key}
              ...
              {onSearch && (
                <div className="row no-gutters">
                  ...
                  <button
                    ...
                    <SVG
                      src={ToAbsoluteUrl('/media/svg/vncheck/reset-filter.svg')}
                      style={iconStyle}
                    />
