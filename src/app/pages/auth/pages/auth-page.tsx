        ...
        <div
          ...
          <div
            ...
            <div className="d-flex flex-row-fluid flex-column justify-content-between">
              ...
              <div className="d-none flex-column-auto d-lg-flex justify-content-between mt-10">
                <div className="opacity-70 font-weight-bold	text-white">&copy; VNU-UET-iFAWcast Team</div>
          ...
          <div
            ...
            <div className="d-flex flex-column-fluid justify-content-center align-items-center flex-column mt-30 mt-lg-0 input-section">
              <div
                className="d-flex justify-content-center align-items-center flex-column mb-10"
                style={{ zIndex: 1 }}>
                {/* <img src={ToAbsoluteUrl('/media/logos/mm-logo.svg')}
                     alt="logo" height="65" width="58"/> */}
                <h6 className="text-center logo-content">iFAWcast</h6>
              </div>
              <Switch>
                <ContentRoute
                  children={null}
