          ...
          <Dropdown.Toggle as={DropdownTopbarItemToggler} id="kt_quick_notifications_toggle">
            <OverlayTrigger
              ...
              <div
                ...
                <span className="svg-icon svg-icon-xl svg-icon-danger">
                  <NotificationsIcon htmlColor={'#27ae60'} />
                </span>
                <span className="pulse-ring" />
                <span className="pulse-ring" />
              </div>
                ...
                <Tab.Container defaultActiveKey={key}>
                  <Nav
                    ...
                    <Nav.Item className="nav-item" as="li">
                      <Nav.Link eventKey="Events" className="nav-link show active"></Nav.Link>
                    </Nav.Item>
                    {/* );
                    })} */}
                  </Nav>
                    ...
                    {notiArr.notification?.length > 0 ? (
                      <Tab.Pane eventKey="Events" key={key}>
                        <PerfectScrollbar
                          ...
                          {notiArr.notification.map((item: any, index: number) => {
                            return (
                              <a
                                ...
                                style={{ backgroundColor: !item.isRead ? '#99ff99' : '' }}
                                ref={ref =>
                          ...
                          {notiArr.hasMore && (
                            <div className="navi-item px-6 pt-5" style={{ maxHeight: '55px' }}>
