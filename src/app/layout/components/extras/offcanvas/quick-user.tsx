    ...
    <div id="kt_quick_user" className="offcanvas offcanvas-right offcanvas p-10">
      <div className="offcanvas-header d-flex align-items-center justify-content-between pb-5">
        <h3 className="font-weight-bold m-0">
          <FormattedMessage id={"USER.ACCOUNT_INFO"} />
        ...
        <div className="d-flex align-items-center mt-5">
          <div className="symbol symbol-100 mr-5">
            <div
              ...
              style={{
                backgroundImage: `url(${user.avatar ? `'${user.avatar}'` : ToAbsoluteUrl(DEFAULT_AVATAR )})`,
              }}
            />
          ...
          <div className="d-flex flex-column">
            ...
            <button className="btn btn-light-primary btn-bold" onClick={() => setShowStatus(true)}>
              <FormattedMessage id={'AUTH.LOG_OUT'} />
            </button>
            <DeleteEntityDialog
              entity={null}
              onDelete={logoutClick}
              isShow={isShow}
              loading={false}
              onHide={() => {
                setShowStatus(false);
              ...
              title={'AUTH.LOG_OUT'}
              confirmMessage={'AUTH.LOG_OUT_CONFIRM_MSG'}
              bodyTitle={'AUTH.EMPTY_STRING'}
              cancelBtn={"COMMON.BTN_CANCEL"}
              deleteBtn={"AUTH.LOG_OUT"}
            />
          </div>
        </div>
          ...
          <a href={"/auth/change-password?callbackUrl=" + callbackUrl} className="navi-item">
            <div className="navi-link">
              ...
              <div className="navi-text">
                <div className="font-weight-bold"><FormattedMessage id={"AUTH.CHANGE_PASSWORD"} /></div>
                <div className="text-muted">
                  <FormattedMessage id={"AUTH.PLEASE_CHANGE_PASSWORD"} />
